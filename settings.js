...
const hintsCss =
  "font-size: 9pt; font-family: 'FiraCode Nerd Font', 'Cascadia Code', 'Helvetica Neue', Helvetica, Arial, sans-serif; border: 0px; color: #e0def4 !important; background: #191724; background-color: #191724";
...
settings.theme = `
  ...
  body {
    ...
    font-family: "FiraCode Nerd Font", "Cascadia Code", "Helvetica Neue", Helvetica, Arial, sans-serif;
    font-size: 12px;
  }
  #sk_omnibar {
    overflow: hidden;
  ...
  kbd {
    ...
    display: inline-block;
    padding: 3px 5px;
    font: 11px "FiraCode Nerd Font", "Cascadia Code", "Helvetica Neue", Helvetica, Arial, sans-serif;
    line-height: 10px;
    vertical-align: middle;
